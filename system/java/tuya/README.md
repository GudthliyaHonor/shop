...
2. 配置java环境变量
3. 复制当前目录下的meituan.jar commons-codec-1.8.jar到java安装目录的/jre/lib/ext
...
5. 执行test.php（php test.php）验证eituan.jar commons-codec-1.8.jar是否引入成功

### linux环境部署
1. 查看java安装目录（如何查看java安装目录自行百度）
2. 复制eituan.jar commons-codec-1.8.jar到到java安装目录的/jre/lib/ext

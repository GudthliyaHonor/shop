...
class Uri implements UriInterface
{
     ...
     * URI construct.
     *
     * @param string $scheme Uri schema, such as 'http', 'https', etc
     * @param string $host Uri host, such as 'www.keylogic.com'
     * @param int $port Uri port, such as 80
     * @param string $path Uri path, such as '/abc/xyz'
     * @param string $query Uri query string
     * @param string $fragment Uri fragment, such as '#xyz'
    ...
    public function getAuthority()
    {
        ...
        return ($userInfo ? $userInfo . '@' : '') . $host . ($port !== null && $port != 80 ? ':' . $port : '');
    }
    ...
    public function withBasePath($basePath)
    {
        if (!is_string($basePath)) {
            throw new InvalidArgumentException('Uri bath path must be a string.');
        }
        if (!empty($basePath)) {
            // Trim on both sides
